...
export default function VehicleCase() {
    // case study data
    const caseStudyData = {
      title: "Vehicle Care App",
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled .",
      image: require("../assets/caseStudy/Vehicle/caseStudy.png"),
    };
    // client feedback data
    const feedbackData = [
      {
        logo: require("../assets/caseStudy/Vehicle/logo.png"),
        client_name: "John P",
        client_position: "xxx",
        feedback:
    ...
    const overviewData = {
      ...
      images: [
        {
          img: require('../assets/caseStudy/Vehicle/mobile.png'),
        },
      ],
    };
    // Project data
    ...
    const prototypeData = [
      {
        prototypeImg: require("../assets/caseStudy/Vehicle/pr1.png"),
      },
      {
        prototypeImg: require("../assets/caseStudy/Vehicle/pr2.png"),
      },
      {
        prototypeImg: require("../assets/caseStudy/Vehicle/pr3.png"),
      },
      {
        prototypeImg: require("../assets/caseStudy/Vehicle/pr4.png"),
      },
      {
        prototypeImg: require("../assets/caseStudy/Vehicle/pr1.png"),
      },
