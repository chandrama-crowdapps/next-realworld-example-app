...
export default function lcgAppCase() {
   // case study data
   const caseStudyData = {
    title: "Labour Care Guide",
    description:
      "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled .",
    image: require("../assets/caseStudy/Lcg/caseStudy.png"),
  };
  ...
  const overviewData = {
    ...
    images: [
      {
        img: require('../assets/caseStudy/Lcg/mobile.png'),
      },
    ],
  };
  // Project data
  ...
  const prototypeData = [
    {
      prototypeImg: require("../assets/caseStudy/Lcg/pr1.png"),
    },
    {
      prototypeImg: require("../assets/caseStudy/Lcg/pr2.png"),
    },
    {
      prototypeImg: require("../assets/caseStudy/Lcg/pr3.png"),
    },
    {
      prototypeImg: require("../assets/caseStudy/Lcg/pr4.png"),
    },
    {
      prototypeImg: require("../assets/caseStudy/Lcg/pr1.png"),
    },
