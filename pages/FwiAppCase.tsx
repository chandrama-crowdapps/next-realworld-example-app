...
export default function FwiAppCase() {
    // case study data
    const caseStudyData = {
    ...
    const overviewData = {
      ...
      images: [
        {
          img: require('../assets/caseStudy/Fwi/overview.png'),
        },
      ],
    };
    // Project data
    ...
    const prototypeData = [
      {
        prototypeImg: require("../assets/caseStudy/Fwi/pr1.png"),
      },
      {
        prototypeImg: require("../assets/caseStudy/Fwi/pr2.png"),
      },
      {
        prototypeImg: require("../assets/caseStudy/Fwi/pr3.png"),
      },
      {
        prototypeImg: require("../assets/caseStudy/Fwi/pr4.png"),
      },
      {
        prototypeImg: require("../assets/caseStudy/Fwi/pr1.png"),
      },
