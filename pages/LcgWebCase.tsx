...
export default function LcgWebCase() {
  // case study data
  const caseStudyData = {
    title: "Receipt Minder",
    description:
      "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled .",
    image: require("../assets/caseStudy/Lcg/web.png"),
  };
  ...
  const overviewData = {
    ...
    images: [
      {
        img: require("../assets/caseStudy/Lcg/overview.png"),
      },
    ],
  };
  // Project data
  ...
  const prototypeData = [
    {
      prototypeImg: require("../assets/caseStudy/Lcg/prototype.png"),
    },
