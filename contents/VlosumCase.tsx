...
export default function VlosumCase() {
   // case study data
   const caseStudyData = {
    title: "VloSum App",
    description:
      "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled .",
    image: require("../assets/caseStudy/Vlosum/caseStudy.png"),
  };
  // client feedback data
  const feedbackData = [
    {
      logo: require("../assets/caseStudy/Vlosum/logo.png"),
      client_name: "John P",
      client_position: "xxx",
      feedback:
  ...
  const overviewData = {
    ...
    images: [
      {
        img: require('../assets/caseStudy/Vlosum/mobile.png'),
      },
    ],
  };
  // Project data
  ...
  const prototypeData = [
    {
      prototypeImg: require("../assets/caseStudy/Vlosum/pr1.png"),
    },
    {
      prototypeImg: require("../assets/caseStudy/Vlosum/pr2.png"),
    },
    {
      prototypeImg: require("../assets/caseStudy/Vlosum/pr3.png"),
    },
    {
      prototypeImg: require("../assets/caseStudy/Vlosum/pr4.png"),
    },
    {
      prototypeImg: require("../assets/caseStudy/Vlosum/pr1.png"),
    },
