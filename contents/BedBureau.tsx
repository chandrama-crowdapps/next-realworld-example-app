...
export default function BedBureau() {
  // case study data
  const caseStudyData = {
  ...
  const feedbackData = [
    {
      logo: require("../assets/img/bedbureau_logo.png"),
      client_name: "John P",
      client_position: "xxx",
      feedback:
  ...
  const overviewData = {
    ...
    images: [
      {
        img:require("../assets/img/bedbureau_overview.png"),
      },
    ],
  };
  // Project data
  ...
  const prototypeData = [
    {
      prototypeImg: require("../assets/img/bedbureau_prototype.png"),
    },
